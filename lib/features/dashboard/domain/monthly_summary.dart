...
class CycleSummary {
  const CycleSummary({
    ...
    required this.grossSalaryPaise,
    required this.salaryDeductionsPaise,
    required this.extraIncomePaise,
  ...
  /// In-hand salary after PF and other deductions.
  final int salaryPaise;
  final int grossSalaryPaise;
  final int salaryDeductionsPaise;
  final int extraIncomePaise;
